...
function addReservationToTable(reservations) {
  ...
  */ if(reservations.length > 0){
     ...
     reservations.map((key,idx) =>{
      ...
      let bookingDateAndTime = new Date(key.time);
        ...
        ele.innerHTML = `
             ...
             <td>${key.price}</td>
             <td>${bookingDateAndTime.toLocaleDateString("en-IN",{day:"numeric", month:"long", year:"numeric"})}, ${bookingDateAndTime.toLocaleTimeString("en-IN")}</td>
             <td>
